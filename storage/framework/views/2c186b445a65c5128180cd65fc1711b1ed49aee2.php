    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card border-0 shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <h5><?php echo e(moneyFormat($revenueMonth)); ?></h5>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <h5><?php echo e(moneyFormat($revenueYear)); ?></h5>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-4">
            <div class="card border-0 shadow mb-4">
                ...
                <!-- Card Body -->
                <div class="card-body">
                    <h5><?php echo e(moneyFormat($revenueAll)); ?></h5>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($success); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($expired); ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($failed); ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
...
<?php echo $__env->make('layouts.app', ['title' => 'Dashboard'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\backend-shop\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>