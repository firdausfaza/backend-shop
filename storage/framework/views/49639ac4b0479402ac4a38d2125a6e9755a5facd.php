...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo e(asset('assets/img/shop-2.png')); ?>" type="image/x-icon">

  <title><?php echo e($title ?? config('app.name')); ?> - Admin Online Shop</title>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">SOLO BUDAYA STORE</div>
      </a>
      ...
      <li class="nav-item <?php echo e(Request::is('admin/category*') ? ' active' :  ''); ?> <?php echo e(Request::is('admin/product*') ? ' active' :  ''); ?>">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          <i class="fa fa-shopping-bag"></i>
          <span>PRODUK</span>
        </a>
        <div id="collapseTwo" class="collapse <?php echo e(Request::is('admin/category*') ? ' show' :  ''); ?> <?php echo e(Request::is('admin/product*') ? ' show' :  ''); ?>" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">KATEGORI & PRODUK</h6>
            <a class="collapse-item <?php echo e(Request::is('admin/category*') ? ' active' : ''); ?>" href="<?php echo e(route('admin.category.index')); ?>">KATEGORI</a>
            <a class="collapse-item <?php echo e(Request::is('admin/product*') ? ' active' : ''); ?>" href="<?php echo e(route('admin.product.index')); ?>">PRODUK</a>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo e(auth()->user()->avatar_url); ?>">
              </a>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-primary" href="<?php echo e(route('logout')); ?>" style="cursor: pointer" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Logout</a>
...
<?php /**PATH C:\laragon\www\backend-shop\resources\views/layouts/app.blade.php ENDPATH**/ ?>