...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo e(asset('assets/img/company.png')); ?>" type="image/x-icon">
    <title><?php echo e($title ?? config('app.name')); ?> - Admin</title>
...
<?php /**PATH C:\laragon\www\backend-shop\resources\views/layouts/auth.blade.php ENDPATH**/ ?>