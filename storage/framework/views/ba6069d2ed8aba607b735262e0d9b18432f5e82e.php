    ...
    function Delete(id) {
        ...
        swal({
            ...
            if (isConfirm) {
                ...
                //ajax delete
                jQuery.ajax({
                    url: "<?php echo e(route("admin.product.index")); ?>/" + id,
                    data: {
                        "id": id,
                        "_token": token
                    },
...
<?php echo $__env->make('layouts.app', ['title' => 'Produk'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\backend-shop\resources\views/admin/product/index.blade.php ENDPATH**/ ?>